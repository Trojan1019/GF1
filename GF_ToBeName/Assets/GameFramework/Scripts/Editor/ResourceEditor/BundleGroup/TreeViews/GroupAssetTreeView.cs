...
namespace UnityGameFramework.Editor.ResourceTools
{
    ...
    internal class GroupAssetTreeView : TreeView
    {
        ...
        protected override void ContextClickedItem(int id)
        {
            ...
            var splitConfigs = EditorUtilityExtend.FindAssets<SplitConfig>();
            foreach (var config in splitConfigs)
            {
                EditorUtilityExtend.AddExportMenuItem(menu, config, Array.ConvertAll(items, input => input.displayName));
            }
