...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class SettingComponent : GameFrameworkComponent
    {
        ...
        private Action<string> _checkSettingNameIsCorrectAction;
        ...
        {
            _checkSettingNameIsCorrectAction?.Invoke(settingName);
        ...
        public void SetCheckSettingNameIsCorrectAction(Action<string> action)
        {
            _checkSettingNameIsCorrectAction = action;
        }
    }
}
