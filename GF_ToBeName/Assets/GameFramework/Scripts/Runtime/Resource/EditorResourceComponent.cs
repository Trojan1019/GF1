...
#pragma warning restore 0067, 0414
        ...
        public void LoadAssetSync(string assetName, Type assetType, LoadAssetCallbacks loadAssetCallbacks, object userData)
        {
            if (string.IsNullOrEmpty(assetName))
            {
                if (loadAssetCallbacks.LoadAssetFailureCallback != null)
            ...
            if (asset == null)
            {
                ...
                if (m_EnableCachedAssets && asset != null)
                {
                    m_CachedAssets.Add(assetName, asset);
                }
#endif
            }
            ...
            else
            {
                if (loadAssetCallbacks.LoadAssetFailureCallback != null)
                {
                    loadAssetCallbacks.LoadAssetFailureCallback(assetName, LoadResourceStatus.AssetError,
                        "Can not load this asset from asset database.", userData);
                }
            }
        }
        ...
        public void SetBundleLoadSuccessCallBack(Action<object> change)
        {
