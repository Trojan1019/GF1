...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class ConfigComponent : GameFrameworkComponent
    {
        ...
        private Action<string> _checkConfigIsCorrect;
        ...
        {
            _checkConfigIsCorrect?.Invoke(configName);
        ...
        public void SetCheckConfigIsCorrectAction(Action<string> action)
        {
            _checkConfigIsCorrect = action;
        }
