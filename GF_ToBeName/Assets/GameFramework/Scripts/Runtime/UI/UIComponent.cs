...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        private void Start()
        {
            ...
            _mainCanvas = m_InstanceRoot.GetComponent<Canvas>();
            
            _uiCamera = _mainCanvas.worldCamera;
        ...
        /// </summary>
        /// <returns>数量</returns>
        public int GetAllLoadingUIFormsCount()
        {
            return m_UIManager.UIFormsBeingLoadedCount;
        }
        ...
        public void CloseLoadingUIForm(int serialId)
        {
            m_UIManager.CloseLoadingUIForm(serialId);
        }

        public void CloseLoadingUIForm(string uiFormAssetName)
        {
            m_UIManager.CloseLoadingUIForm(uiFormAssetName);
        }
        ...
        {
            Log.Error("Open UI form failure, asset name '{0}', UI group name '{1}', pause covered UI form '{2}', error message '{3}'.", e.UIFormAssetName, e.UIGroupName, e.PauseCoveredUIForm.ToString(), e.ErrorMessage);
