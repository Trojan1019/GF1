    ...
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        private sealed partial class ResourceLoader
        {
            private sealed class LoadDependencyAssetTask : LoadResourceTaskBase
            {
                ...
                public override bool IsDependencyAsset
                {
                    get
                    {
                        return true;
                ...
                public override void OnLoadDependencyAssetSuccess(object resourceObject)
                {
                    base.OnLoadDependencyAssetSuccess(resourceObject);
                    
                    m_MainTask.OnAddDependencyResource(resourceObject);
