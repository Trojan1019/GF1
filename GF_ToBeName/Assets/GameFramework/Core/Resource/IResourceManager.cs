...
namespace GameFramework.Resource
{
    ...
    public interface IResourceManager
    {
        ...
        /// <param name="loadAssetCallbacks">加载资源回调函数集。</param>
        /// <param name="userData">用户自定义数据。</param>
        void LoadAssetSync(string assetName, Type assetType, LoadAssetCallbacks loadAssetCallbacks, object userData);
        ...
        void SetBundleLoadSuccessCallBack(Action<object> change);
    }
}
