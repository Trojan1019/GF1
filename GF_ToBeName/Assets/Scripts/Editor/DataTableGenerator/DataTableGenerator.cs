...
namespace NewSideGame
{
    ...
    {
        public const string DataTablePath = "Assets/Game/DataTables";
        private const string CSharpCodePath = "Assets/Scripts/DataTables";
        private const string CSharpCodeTemplateFileName = "Assets/Editor/DataTable/DataTableCodeTemplate.txt";
        private static readonly Regex EndWithNumberRegex = new Regex(@"\d+$");
        private static readonly Regex NameRegex = new Regex(@"^[A-Z][A-Za-z0-9_]*$");

        public static DataTableProcessor CreateDataTableProcessor(string dataTablePath)
        {
            return new DataTableProcessor(Utility.Path.GetRegularPath(dataTablePath),
                Encoding.GetEncoding("UTF-8"), 0, 1, null, 0, 2, 1);
        }
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "NewSideGame");
